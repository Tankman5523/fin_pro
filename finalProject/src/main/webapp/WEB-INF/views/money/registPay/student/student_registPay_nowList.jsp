        ...
        <div id="content">
            ...
            <div id="content_1">
				<div style="width: 90%;height: 90%;margin: 5%;">
                    ...
                    <br>
                    <label for="">납부기간</label><input type="date" name="startDate" id="startDate" value="${RegistPay.startDate}" readonly> ~ <input type="date" name="endDate" id="endDate" value="${RegistPay.endDate}" readonly>
                    <br><br>
                    ...
                    <fieldset>
                        <ul>
                            <li>등록금 납부는 학기 시작 전 1달 이내 부터 2주이며 당일부터 문자발송됩니다. 납부기한 만료시 입학/등록이 취소될 수 있으니 반드시 기한 지켜주시기 바랍니다.</li>
                            <li>등록금 입금 계좌는 본인이 학과 내 조사간 입력 / 혹은 입학처에 문의한 계좌입니다.</li>
                            <li>금액 초과시에는 초과금이 자동으로 입금하신 계좌로 환급되오니 이점 인지바랍니다.</li>
