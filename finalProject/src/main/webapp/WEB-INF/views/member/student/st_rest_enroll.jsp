	                    ...
	                    <div style="border-top:1px solid black; width:90%">
	                        ...
	                        <table border="1">
	                            <tr>
	                                ...
	                                <td>학번</td>
	                                <td><input type="text" value="${loginUser.studentNo }" name="studentNo" readonly></td>
	                            </tr>
	                            <tr>
	                                <td>학과</td>
	                                <td><input type="text" value="${loginUser.departmentNo }" readonly></td>
	                                <td>이메일</td>
	                                <td><input type="text" value="${loginUser.email }" readonly></td>
	                            </tr>
	                            <tr>
	                                <td>학년</td>
	                                <td><input type="text" value="${loginUser.classLevel }" readonly></td>
	                                <td>연락처</td>
